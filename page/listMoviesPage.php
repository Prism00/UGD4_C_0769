...
?>
    <div class="container p-3 m-4 h-100" style="background-color: #FFFFFF; border-top: 5px solid #D40013; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);" >
        ...
        <a type="button" class="btn btn-primary" href="../page/tambahMovie.php">Tambah Movie</a>
        <hr>
        <table class="table ">
        <thead>
            <tr>
        ...
        <tbody>
            ...
            if (mysqli_num_rows($query) == 0) {
                ...
                while($data = mysqli_fetch_assoc($query)){
                    ...
                    <td>'.$data['season'].'</td>
                    <td>
                        <a href="../page/editMovie.php?id='.$data['id'].'" onClick="return confirm ( \'Are you sure want to Edit this data?\')"> <i style="color: blue" class="fa fa-pencil fa-2x"></i>
                        </a>
